...
async function getFromApi() {
    try {
        ...
        if (region === 'Africa') regionColor = 'blue';
        else if (region === 'Americas') regionColor = 'green';
        else if (region === 'Asia') regionColor = 'red';
        else if (region === 'Europe') regionColor = 'yellow';
        else if (region === 'Oceania') regionColor = 'purple';
        else regionColor = 'black';
